...
# Files to read
files = ["val_simulation_adapted.csv", "val_real_adapted.csv"]
...
saved_files_user = ["val_adapted_user.pdf", "val_adapted_user_real.pdf"]
...
for fi, f in enumerate(files):
	...
	# Y axis
	ax.set_ylim([0, 100])
	ax.set_ylabel("Valence", fontsize=30, weight="bold")
