...
data_path =  "/home/marcosm/ROS/catkin_workspace/src/motivational_dms/data/log/" + file_date + "/motivation/homeostatic_variable-"

if not os.path.exists(data_save):
    os.makedirs(data_save)

homeostatic_variables = ["entertain", "tiredness", "social_need"]
color = ["b", "g", "r"]

for p, variable in enumerate(homeostatic_variables):
